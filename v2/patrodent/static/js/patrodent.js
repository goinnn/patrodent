var initPhotoSwipeFromDOM = function (gallerySelector) {
    ...
    var parseThumbnailElements = function (el) {
        ...
        for (var i = 0; i < numNodes; i++) {
            ...
            linkEl = $(figureEl).find("a.image")[0];
            if (linkEl !== undefined) {
...
function resizeGallery() {
    ...
    carousel.find(".photo-item").each(function (i, val) {
        var width = $(val).parents(".jcarousel").outerWidth();
        $(val).find("figure").css({"width": width + "px"});
