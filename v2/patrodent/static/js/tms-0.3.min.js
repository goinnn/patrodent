...
_.banners[i]=(tmp=$('.'+_.bannerCl,this)).length?tmp.css({zIndex:999}):false})},bannerDuration:1000,bannerEasing:'swing',bannersPresets:{fromLeft:{bannerShow:function(banner,_){if(banner.css('top')=='auto')
banner.css('top',0)
...
},bannerHide:function(banner,_){banner.show().fadeOut(_.bannerDuration)
}}},numStatusChFu:function(){var _=this
